<HTML>
<HEAD>
<TITLE>servicios final</TITLE>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=iso-8859-1">
<!-- Script (servicios final) -->
...
function preloadImages() {
	if (document.images) {
		servicios_05_ImageMap_01_over = newImage("images/servicios_05-ImageMap_01_ov.gif");
		servicios_05_ImageMap_02_over = newImage("images/servicios_05-ImageMap_02_ov.gif");
		servicios_08_ImageMap_02_over = newImage("images/servicios_08-ImageMap_02_ov.gif");
		servicios_08_ImageMap_03_over = newImage("images/servicios_08-ImageMap_03_ov.gif");
		servicios_08_ImageMap_04_over = newImage("images/servicios_08-ImageMap_04_ov.gif");
		servicios_09_ImageMap_05_over = newImage("images/servicios_09-ImageMap_05_ov.gif");
		servicios_09_ImageMap_06_over = newImage("images/servicios_09-ImageMap_06_ov.gif");
		preloadFlag = true;
	}
}
...
<!-- End Preload Script -->
<link href="estilo/servicios.css" rel="stylesheet" type="text/css">
</HEAD>
...
<tr>
	...
	ONMOUSEOUT="changeImages('Index_01', 'images/Index_01.gif'); return true;">
                ...
                <td width="250"><IMG NAME="Index_02" SRC="images/Index_02.gif" WIDTH=264 HEIGHT=119 BORDER=0 USEMAP="#Index_02_Map"> 
	...
	ONMOUSEOUT="changeImages('Index_02', 'images/Index_02.gif'); return true;">
                ...
                <td width="281"><IMG NAME="Index_03" SRC="images/Index_03.gif" WIDTH=267 HEIGHT=119 BORDER=0 USEMAP="#Index_03_Map"> 
	...
	ONMOUSEOUT="changeImages('Index_03', 'images/Index_03.gif'); return true;">
        ...
        <TR> 
          <TD> <IMG SRC="images/servicios_02.gif" WIDTH=295 HEIGHT=57></TD>
          <TD> <IMG SRC="images/servicios_03.gif" WIDTH=385 HEIGHT=57></TD>
          <TD> <IMG SRC="images/servicios_04.gif" WIDTH=120 HEIGHT=57></TD>
        </TR>
        <TR> 
