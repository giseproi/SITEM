<HTML>
<HEAD>
<TITLE>noticias final</TITLE>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=iso-8859-1">
<!-- Script (noticias final) -->
...
function preloadImages() {
	if (document.images) {
		noticias_05_ImageMap_01_over = newImage("images/noticias_05-ImageMap_01_ove.gif");
		noticias_05_ImageMap_02_over = newImage("images/noticias_05-ImageMap_02_ove.gif");
		noticias_08_ImageMap_02_over = newImage("images/noticias_08-ImageMap_02_ove.gif");
		noticias_08_ImageMap_03_over = newImage("images/noticias_08-ImageMap_03_ove.gif");
		noticias_08_ImageMap_04_over = newImage("images/noticias_08-ImageMap_04_ove.gif");
		noticias_09_ImageMap_04_over = newImage("images/noticias_09-ImageMap_04_ove.gif");
		noticias_09_ImageMap_05_over = newImage("images/noticias_09-ImageMap_05_ove.gif");
		noticias_09_ImageMap_06_over = newImage("images/noticias_09-ImageMap_06_ove.gif");
		preloadFlag = true;
	}
}
...
<!-- End Preload Script -->
<link href="estilo/noticias.css" rel="stylesheet" type="text/css">
</HEAD>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
      ...
      <TABLE WIDTH=800 BORDER=0 CELLPADDING=0 CELLSPACING=0>
        <TR> 
          <TD COLSPAN=3> <table width="800" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><IMG NAME="Index_01" SRC="images/Index_01.gif" WIDTH=269 HEIGHT=119 BORDER=0 USEMAP="#Index_01_Map"> 
	...
	ONMOUSEOUT="changeImages('Index_02', 'images/Index_02.gif'); return true;">
                    <AREA SHAPE="rect" ALT="" COORDS="98,84,164,104" HREF="noticias.html"
	...
	ONMOUSEOUT="changeImages('Index_03', 'images/Index_03.gif'); return true;">
        ...
        <TR> 
          <TD> <IMG SRC="images/noticias_02.gif" WIDTH=295 HEIGHT=57></TD>
          <TD> <IMG SRC="images/noticias_03.gif" WIDTH=385 HEIGHT=57></TD>
          <TD> <IMG SRC="images/noticias_04.gif" WIDTH=120 HEIGHT=57></TD>
        </TR>
        <TR> 
          <TD colspan="3" class="noticias">&nbsp;</TD>
        </TR>
        <TR> 
          <TD COLSPAN=3> <IMG SRC="images/noticias_10.gif" WIDTH=800 HEIGHT=35></TD>
        </TR>
      </TABLE>
      <p> 
        <!-- End  -->
