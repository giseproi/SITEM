<?
	...
	$this->cadena_select="SELECT max(id_marca) from marca";
...
<div align="center">
  <p>&nbsp;</p>
  <p><strong><font color="#0033CC" size="4" face="Arial, Helvetica, sans-serif">Marca de Equipos 
    </font></strong></p>
  <p>&nbsp; </p>
</div>
<form name="form1" method="post" action="015.php">
  <div align="center">
    <table width="580" border="0" cellspacing="4" cellpadding="0">
      <tr> 
        <td width="260"><div align="right"><strong><font color="#000033" size="2" face="Arial, Helvetica, sans-serif">C&oacute;digo Marca</font></strong></div></td>
        <td width="320"><strong><font color="#000033" size="2" face="Arial, Helvetica, sans-serif"> 
          <input type="text" name="id_marca" value=" <? echo $maximo; ?> " readonly="readonly">
          </font></strong></td>
      </tr>
      <tr> 
        <td><div align="right"><strong><font color="#000033" size="2" face="Arial, Helvetica, sans-serif">Nombre de la Marca</font></strong></div></td>
      ...
      <tr> 
        <td colspan="2" align="center"> <strong><font color="#000033" size="2" face="Arial, Helvetica, sans-serif"> 
          <input type="submit" name="015" value="Enviar">
          </font></strong></td>
      </tr>
    </table>
  </div>
