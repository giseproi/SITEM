<?
	...
	$this->cadena_select="SELECT max(id_servicio_telecom) from servicio_telecom";
...
<div align="center">
  <p>&nbsp;</p>
  <p><strong><font color="#0033CC" size="4" face="Arial, Helvetica, sans-serif">Servicios 
    de Telecomunicaciones </font></strong></p>
  <p>&nbsp; </p>
</div>
<form name="form1" method="post" action="026.php">
  <div align="center">
