<?
	...
	$this->cadena_select="SELECT max(id_interfaz) from interfaz";
...
<div align="center">
  <p>&nbsp;</p>
  <p><strong><font color="#0033CC" size="4" face="Arial, Helvetica, sans-serif">Interfaces</font></strong></p>
  <p>&nbsp; </p>
</div>
<form name="form1" method="post" action="017.php">
  <div align="center">
    <table width="580" border="0" cellspacing="4" cellpadding="0">
      ...
      <tr> 
        <td colspan="2" align="center"> <strong><font color="#000033" size="2" face="Arial, Helvetica, sans-serif"> 
          <input type="submit" name="017" value="Enviar">
          </font></strong></td>
      </tr>
    </table>
  </div>
