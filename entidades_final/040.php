...
include_once($_SERVER['DOCUMENT_ROOT'].'/sitem/tecnologias_final/header_tecnologias.php');	
	...
	if(isset($_GET["mt"])){
			include_once($_SERVER['DOCUMENT_ROOT'].'/sitem/tecnologias_final/042action.php');	

	}else
		{
		if(!isset($_GET["it"]))
		{
		include_once($_SERVER['DOCUMENT_ROOT'].'/sitem/tecnologias_final/040action.php');	

		}else
			{
			include_once($_SERVER['DOCUMENT_ROOT'].'/sitem/tecnologias_final/041action.php');	
		}
}			
