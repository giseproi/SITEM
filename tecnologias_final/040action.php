<?
	...
	$this->cadena_select_2="SELECT * FROM tecnologia_conexion";
...
Estas son las Tecnolog&iacute;as de Interconexi&oacute;n que se encuentran registradas en el Sistema.<br>
	...
	{
?>
            <tr><td width="124"><div align="left"><strong><a href="040.php?it=<? echo $registro[$j][0] ?>" class="menuprincipal" onMouseOver="this.style.color='#0033CC';" onMouseOut="this.style.color='#000033';" > 
