<HTML>
<HEAD>
<TITLE>organizaciones final</TITLE>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=iso-8859-1">
<!-- Script (organizaciones final) -->
...
function preloadImages() {
	if (document.images) {
		organizaciones_05_ImageMap_01_over = newImage("images/organizaciones_05-ImageMap_.gif");
		organizaciones_05_ImageMap_02_over = newImage("images/organizaciones_05-ImageM-07.gif");
		organizaciones_08_ImageMap_02_over = newImage("images/organizaciones_08-ImageMap_.gif");
		organizaciones_08_ImageMap_03_over = newImage("images/organizaciones_08-ImageM-12.gif");
		organizaciones_08_ImageMap_04_over = newImage("images/organizaciones_08-ImageM-13.gif");
		organizaciones_09_ImageMap_05_over = newImage("images/organizaciones_09-ImageMap_.gif");
		organizaciones_09_ImageMap_06_over = newImage("images/organizaciones_09-ImageM-16.gif");
		preloadFlag = true;
	}
}
...
<!-- End Preload Script -->
<link href="estilo/organizaciones.css" rel="stylesheet" type="text/css">
</HEAD>
...
<tr>
	...
	ONMOUSEOUT="changeImages('Index_01', 'images/Index_01.gif'); return true;">
                ...
                <td width="265"><IMG NAME="Index_02" SRC="images/Index_02.gif" WIDTH=264 HEIGHT=119 BORDER=0 USEMAP="#Index_02_Map"> 
	...
	ONMOUSEOUT="changeImages('Index_02', 'images/Index_02.gif'); return true;">
                ...
                <td width="266"><IMG NAME="Index_03" SRC="images/Index_03.gif" WIDTH=267 HEIGHT=119 BORDER=0 USEMAP="#Index_03_Map"> 
	...
	ONMOUSEOUT="changeImages('Index_03', 'images/Index_03.gif'); return true;">
        ...
        <TR> 
          <TD> <IMG SRC="images/organizaciones_02.gif" WIDTH=295 HEIGHT=57></TD>
          <TD> <IMG SRC="images/organizaciones_03.gif" WIDTH=385 HEIGHT=57></TD>
          <TD> <IMG SRC="images/organizaciones_04.gif" WIDTH=120 HEIGHT=57></TD>
        </TR>
        <TR> 
          <TD height="21" colspan="3"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td class="organizaciones">