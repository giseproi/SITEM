...
function preloadImages() {
	if (document.images) {
		foros_05_ImageMap_01_over = newImage("images/foros_05-ImageMap_01_over.gif");
		foros_05_ImageMap_02_over = newImage("images/foros_05-ImageMap_02_over.gif");
		foros_08_ImageMap_02_over = newImage("images/foros_08-ImageMap_02_over.gif");
		foros_08_ImageMap_03_over = newImage("images/foros_08-ImageMap_03_over.gif");
		foros_08_ImageMap_04_over = newImage("images/foros_08-ImageMap_04_over.gif");
		foros_09_ImageMap_05_over = newImage("images/foros_09-ImageMap_05_over.gif");
		foros_09_ImageMap_06_over = newImage("images/foros_09-ImageMap_06_over.gif");
		preloadFlag = true;
	}
}
...
<!-- End Preload Script -->
<link href="estilo/foros.css" rel="stylesheet" type="text/css">
</HEAD>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	ONMOUSEOUT="changeImages('Index_01', 'images/Index_01.gif'); return true;">
                ...
                <td><IMG NAME="Index_02" SRC="images/Index_02.gif" WIDTH=264 HEIGHT=119 BORDER=0 USEMAP="#Index_02_Map"> 
                  <MAP NAME="Index_02_Map">
                    <AREA SHAPE="rect" ALT="" COORDS="205,84,264,104" HREF="foros.html"
	...
	ONMOUSEOUT="changeImages('Index_03', 'images/Index_03.gif'); return true;">
        ...
        <TR> 
          <TD> <IMG SRC="images/foros_02.gif" WIDTH=295 HEIGHT=57></TD>
          <TD> <IMG SRC="images/foros_03.gif" WIDTH=385 HEIGHT=57></TD>
          <TD> <IMG SRC="images/foros_04.gif" WIDTH=120 HEIGHT=57></TD>
        </TR>
        <TR valign="top"> 
          <TD colspan="3" class="foros">&nbsp;</TD>
        </TR>
        <TR> 
          <TD COLSPAN=3> <IMG SRC="images/foros_10.gif" WIDTH=800 HEIGHT=35></TD>
        </TR>
      </TABLE>
      <p align="center"> 
        <!-- End  -->
