<?
	...
	$tabla=$_POST['tabla'];
	$this->cadena_select_2="SELECT * FROM ".$tabla." ORDER BY id_".$tabla."";
...
<div align="center"> <? echo "<div align='center'><font face='Arial, Helvetica, sans-serif' color='#000033' size='2'>Estos son los registros de la tabla <strong>".$tabla."</strong> que se encuentran en el Sistema.<br>
	...
	{
?>
            <tr><td width="124"><div align="left"><strong><a href="080.php?id=<? echo $registro[$j][0] ?>&tb=<? echo $tabla ?>" class="menuprincipal" onMouseOver="this.style.color='#0033CC';" onMouseOut="this.style.color='#000033';" > 
